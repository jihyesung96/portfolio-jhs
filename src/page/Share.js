...
const Share = () => {
    return (
        <div id='Share'>
            ...
            <div>
                <span id='Contenttitle2'  className='Sharetitle'>📌나만의 정리 노트</span>
                <h2 id='Contenttitle3' className='Sharelink'><a href='https://aboard-teller-7ff.notion.site/STUDY-45aa50e4f0874c188ab1a3f40e414b17'>노션</a></h2>
