...
const Aboutme = () => {
    return (
        <div id='Aboutme'>
            ...
            <div>
                <span id='Contenttitle2'>📌직장</span>    
                <h2 id='Contenttitle3'>아이티공간</h2>
                <p id='Contenttitle4'>👍2023/09/1 ~ 현재</p>
                <p>솔루션 프론트엔드 개발</p>
            </div>
            <div>
                ...
                <ul id='skillul'>
                    ...
                    <li class="skillli skillgit">
                        ...
                        <span class="status-Git">GIT을 이용하여 프로젝트를 관리 및 협업을 할 수 있습니다.</span>
                    </li>
                </ul>
            </div>
        </div>
