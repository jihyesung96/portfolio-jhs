    ...
    return (
        <div id='Title'>
            ...
            <div>
                ...
                <ul>
                    <li id='Titleulflex' style={scrollnum==12 ? { color:'rgb(248, 205, 7)' }: { color:'inherit' } }><div style={scrollnum==12 ? { backgroundColor:'rgb(248, 205, 7)' }: { backgroundColor:'rgb(110, 110, 110)' }} class="Circle"></div>야구게임</li>
                    <li id='Titleulflex' style={scrollnum==13 ? { color:'rgb(248, 205, 7)' }: { color:'inherit' } }><div style={scrollnum==13 ? { backgroundColor:'rgb(248, 205, 7)' }: { backgroundColor:'rgb(110, 110, 110)' }} class="Circle"></div>AW뮤직</li>
                    <li id='Titleulflex' style={scrollnum==14 ? { color:'rgb(248, 205, 7)' }: { color:'inherit' } }><div style={scrollnum==14 ? { backgroundColor:'rgb(248, 205, 7)' }: { backgroundColor:'rgb(110, 110, 110)' }} class="Circle"></div>AW카페</li>
                </ul>
            </div>
            <div>
                <h1 style={scrollnum==15 ? { scale:'1.1' }: { scale:'1' } }>Q&A</h1>
                <ul>
                    <li id='Titleulflex' style={scrollnum==16 ? { color:'rgb(248, 205, 7)' }: { color:'inherit' } }><div style={scrollnum==16 ? { backgroundColor:'rgb(248, 205, 7)' }: { backgroundColor:'rgb(110, 110, 110)' }} class="Circle"></div>질문1</li>
                    <li id='Titleulflex' style={scrollnum==17 ? { color:'rgb(248, 205, 7)' }: { color:'inherit' } }><div style={scrollnum==17 ? { backgroundColor:'rgb(248, 205, 7)' }: { backgroundColor:'rgb(110, 110, 110)' }} class="Circle"></div>질문2</li>
                    <li id='Titleulflex' style={scrollnum==18 ? { color:'rgb(248, 205, 7)' }: { color:'inherit' } }><div style={scrollnum==18 ? { backgroundColor:'rgb(248, 205, 7)' }: { backgroundColor:'rgb(110, 110, 110)' }} class="Circle"></div>질문3</li>
            ...
            <div>
                <h1 style={scrollnum==20 ? { scale:'1.1' }: { scale:'1' } }>CONTACT</h1>
            </div>
        </div>
    );
};
